...
$query = "SELECT 
            m.nom, 
            m.prenom, 
            GROUP_CONCAT(mo.nom_mois ORDER BY FIELD(mo.nom_mois, 'Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre') SEPARATOR ', ') AS mois_arrieres, 
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between">
                  <form class="d-flex w-100 mt-3" action="" method="GET">
                      ...
                      if ($rs) {
                        foreach ($rs as $res) {
                          ...
                          <div class="col-12 col-md-6 col-lg-3 mb-4">
                            <div class="card">
                              <div class="card-body">
                                <h5 class="card-title"><?= $res['nom'] ?>     <?= $res['prenom'] ?></h5>
                                <p class="card-text">
                                  <strong>Mois Arriéré(s):</strong> <?= $res['mois_arrieres'] ?><br>
                                  <strong>Montant Arrieré(s):</strong>
                                  <?= isset($res["montant_du"]) ? number_format($res['montant_du'], "0", ",") . " " . "fcfa" : '0 FCFA' ?>
                                </p>
                              </div>
                            </div>
                        ...
                        <div class="col-12">
                          <div class="alert alert-info text-center">Aucune information disponible</div>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
