                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="Actions">
                      ...
                      <?php } ?>
                      <a href="./modifierRetrait.php?id=<?= $value['id_rc'] ?>" class="btn btn-outline-warning" title="Modifier">
                        <i class="far fa-edit" style="font-size: 20px;"></i>
                      </a>
                      <a href="./deleteRetrait.php?id=<?= $value['id_rc'] ?>" class="btn btn-outline-danger" title="Supprimer" onclick="return confirm('Voulez-vous vraiment effectuer la suppression?')">
          ...
          foreach ($values as $value) { ?>
            <div class="card mb-3">
              <div class="card-body">
                ...
                <p class="card-text">Date de retrait: <?= date_format(date_create($value['date_retrait']), "d-m-Y") ?></p>
                <div class="btn-group" role="group" aria-label="Actions">
                  <?php if (!empty($value['id_rc'])) { ?>
